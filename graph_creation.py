...
if __name__ == '__main__':
    ...
    training_dataset_dict = create_scenario_dataset_dict(training_files)    # {fileID1: [scenarios...]}
    ...
    graphs_of_training_scenarios = get_graphs_for_scenarios(training_dataset_dict, radius, graph_creation_method)   # {scenarioID1: [PyGgraphs...], ...}
