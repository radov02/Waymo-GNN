...
_OCCUPANCYFLOWTASKCONFIG = DESCRIPTOR.message_types_by_name['OccupancyFlowTaskConfig']
_OCCUPANCYFLOWMETRICS = DESCRIPTOR.message_types_by_name['OccupancyFlowMetrics']
