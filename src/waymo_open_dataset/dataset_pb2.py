...
_MATRIXSHAPE = DESCRIPTOR.message_types_by_name['MatrixShape']
_MATRIXFLOAT = DESCRIPTOR.message_types_by_name['MatrixFloat']
_MATRIXINT32 = DESCRIPTOR.message_types_by_name['MatrixInt32']
_CAMERANAME = DESCRIPTOR.message_types_by_name['CameraName']
_LASERNAME = DESCRIPTOR.message_types_by_name['LaserName']
_TRANSFORM = DESCRIPTOR.message_types_by_name['Transform']
_VELOCITY = DESCRIPTOR.message_types_by_name['Velocity']
_CAMERACALIBRATION = DESCRIPTOR.message_types_by_name['CameraCalibration']
_LASERCALIBRATION = DESCRIPTOR.message_types_by_name['LaserCalibration']
_CONTEXT = DESCRIPTOR.message_types_by_name['Context']
_CONTEXT_STATS = _CONTEXT.nested_types_by_name['Stats']
_CONTEXT_STATS_OBJECTCOUNT = _CONTEXT_STATS.nested_types_by_name['ObjectCount']
_RANGEIMAGE = DESCRIPTOR.message_types_by_name['RangeImage']
_CAMERASEGMENTATIONLABEL = DESCRIPTOR.message_types_by_name['CameraSegmentationLabel']
_CAMERASEGMENTATIONLABEL_INSTANCEIDTOGLOBALIDMAPPING = _CAMERASEGMENTATIONLABEL.nested_types_by_name['InstanceIDToGlobalIDMapping']
_CAMERAIMAGE = DESCRIPTOR.message_types_by_name['CameraImage']
_CAMERALABELS = DESCRIPTOR.message_types_by_name['CameraLabels']
_LASER = DESCRIPTOR.message_types_by_name['Laser']
_FRAME = DESCRIPTOR.message_types_by_name['Frame']
_CAMERANAME_NAME = _CAMERANAME.enum_types_by_name['Name']
_LASERNAME_NAME = _LASERNAME.enum_types_by_name['Name']
_CAMERACALIBRATION_ROLLINGSHUTTERREADOUTDIRECTION = _CAMERACALIBRATION.enum_types_by_name['RollingShutterReadOutDirection']
