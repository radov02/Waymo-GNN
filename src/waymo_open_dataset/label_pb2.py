...
_LABEL_BOX = _LABEL.nested_types_by_name['Box']
_LABEL_METADATA = _LABEL.nested_types_by_name['Metadata']
_LABEL_ASSOCIATION = _LABEL.nested_types_by_name['Association']
_POLYGON2DPROTO = DESCRIPTOR.message_types_by_name['Polygon2dProto']
_LABEL_BOX_TYPE = _LABEL_BOX.enum_types_by_name['Type']
_LABEL_TYPE = _LABEL.enum_types_by_name['Type']
_LABEL_DIFFICULTYLEVEL = _LABEL.enum_types_by_name['DifficultyLevel']
